...
import { User, Bell, Shield, Globe, CreditCard, ChevronRight, Moon, Sun, Monitor, Save, Key, Mail, Lock, Languages, Clock, Coins } from 'lucide-react';
  ...
  return (
    <div className="space-y-12">
      <div className="flex justify-between items-end">
        ...
        <button className="flex items-center gap-2 px-8 h-14 bg-black text-white rounded-[20px] text-sm font-black uppercase tracking-widest hover:opacity-90 transition-all shadow-xl shadow-black/10">
                    ...
                    <div className="space-y-10">
                       ...
                       <div className="grid grid-cols-2 gap-8">
                          <div className="space-y-4">
                             <label className="text-[10px] font-black text-[#bbbbbb] uppercase tracking-[0.2em]">Deployment ID</label>
                             <div className="relative">
                                <Mail className="w-5 h-5 absolute left-4 top-1/2 -translate-y-1/2 text-[#bbbbbb]" />
                                <input className="w-full h-14 pl-12 pr-6 bg-[#f5f5f5] border border-transparent rounded-2xl text-sm font-bold focus:bg-white focus:border-[#eeeeee] outline-none transition-all" defaultValue="eduardo@wised.io" />
                             </div>
                          </div>
                          <div className="space-y-4">
                             <label className="text-[10px] font-black text-[#bbbbbb] uppercase tracking-[0.2em]">Operator Tag</label>
                             <div className="relative">
                                <User className="w-5 h-5 absolute left-4 top-1/2 -translate-y-1/2 text-[#bbbbbb]" />
                                <input className="w-full h-14 pl-12 pr-6 bg-[#f5f5f5] border border-transparent rounded-2xl text-sm font-bold focus:bg-white focus:border-[#eeeeee] outline-none transition-all" defaultValue="Eduardo Manlangit" />
                             </div>
                          </div>
                       </div>
                    </div>
                    ...
                    <div className="space-y-10">
                       ...
                       <div className="grid grid-cols-2 gap-8">
                          <div className="space-y-3">
                             <label className="text-[10px] font-black text-[#bbbbbb] uppercase tracking-[0.2em]">Interface Language</label>
                             <div className="relative">
                                <Languages className="w-5 h-5 absolute left-4 top-1/2 -translate-y-1/2 text-[#bbbbbb]" />
                                <select className="w-full h-14 pl-12 pr-6 bg-[#f5f5f5] border border-transparent rounded-2xl text-sm font-bold focus:bg-white focus:border-[#eeeeee] outline-none appearance-none transition-all">
                          ...
                          <div className="space-y-3">
                             <label className="text-[10px] font-black text-[#bbbbbb] uppercase tracking-[0.2em]">System Timezone</label>
                             <div className="relative">
                                <Clock className="w-5 h-5 absolute left-4 top-1/2 -translate-y-1/2 text-[#bbbbbb]" />
                                <select className="w-full h-14 pl-12 pr-6 bg-[#f5f5f5] border border-transparent rounded-2xl text-sm font-bold focus:bg-white focus:border-[#eeeeee] outline-none appearance-none transition-all text-xs">
                       ...
                       <div className="space-y-3">
                          <label className="text-[10px] font-black text-[#bbbbbb] uppercase tracking-[0.2em]">Fiscal Currency</label>
                          <div className="relative">
