...
import { ChevronDown, Package, Briefcase, Loader2, Target, DollarSign, Users, TrendingUp, Calendar, ArrowUpRight } from 'lucide-react';
...
const Dashboard = () => {
  ...
  const statCards = [
    { label: 'CONVERSION TARGET', value: '1', change: '12.5%', icon: Target, trend: 'up' },
    { label: 'FORECAST REVENUE', value: '$' + (stats.revenue / 1000).toFixed(0) + 'k', change: '8.2%', icon: DollarSign, trend: 'up' },
    { label: 'NETWORK REACH', value: stats.totalCustomers.toString(), change: '2.4%', icon: Users, trend: 'up' },
    { label: 'GROWTH VELOCITY', value: '24', change: '15%', icon: TrendingUp, trend: 'up' },
  ];
  ...
  return (
    <div className="space-y-10">
      ...
      <div className="flex justify-end">
        <button className="flex items-center gap-2 px-4 py-2 border border-[#f1f1f1] rounded-xl text-sm font-bold bg-white hover:bg-gray-50 transition-colors shadow-sm">
          Performance
