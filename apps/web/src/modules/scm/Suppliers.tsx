    ...
    <div className="space-y-10">
      <div className="flex justify-between items-end">
        <div className="space-y-2">
          <h2 className="text-[42px] font-bold tracking-tight text-[#111111] leading-[1.1]">Suppliers</h2>
          <p className="text-[#6b7280] text-lg font-medium">Manage and monitor your external supply chain partners.</p>
        </div>
        <button 
